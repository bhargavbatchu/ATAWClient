...
var respText = '';
var app = angular.module("erpinstance", ['ngRoute', 'ngDialog', 'chart.js', '720kb.datepicker', 'scrollable-table'])
  ...
  $http.get(serviceurl+"/getSOURCES")
    .success(function (data)
	 ...
	 $scope.GetSourcetable = function (instances) {
		...
		jsonObject.Instance_Name = getSourcetb;
		var jsonString = JSON.stringify(jsonObject);
				// $http.get(serviceurl+'/getSourceTables?serverData=%7B"Instance_Name":"'+getSourcetb+'"%7D')
				$http.get(serviceurl+'/getSourceTables?serverData='+encodeURIComponent(jsonString))
						.success(function (data)
						 {
							// alert(data);
		...
		var sourceArray = [];
			...
			//$http.post(serviceurl+'/generateXML?serverData='+jsonString)
					$http({
						...
						url: serviceurl+'/generateXML?serverData=' + encodeURIComponent(jsonString),
						responseType:'json'
						})
 ...
 ////////////// get database values on select option ///////////////////////
	 $scope.GetDb = function (instances) {
		...
		//$scope.loading = !$scope.loading;
				...
				var jsonObject = new Object();
				jsonObject.Instance_Name = getSourceinstances;
				var jsonString = JSON.stringify(jsonObject);
				
				$http.get(serviceurl+'/getDatabases?serverData='+ encodeURIComponent(jsonString))
						.success(function (data)
						 {
							// alert(data);
							 $scope.dbnames = data;							 
	 ...
	 $scope.GetTable = function () {
		 ...
		 $scope.tblname = [];
               ...
               // alert("Selected Value: " + getSourceinstances);
				...
				$http.get(serviceurl+'/getTables?serverData=%7B"Database_Name":"'+getSourcedb+'","Instance_Name":"'+$scope.Sourceinstances+'"%7D')
						.success(function (data)
						 {
							 //alert(data);
							 debugger;
	...
	////////////// get database values on select option ///////////////////////
	 $scope.targetGetDb = function () {
		 ...
		 //alert(instances);
				...
				$http.get(serviceurl+'/getDatabases?serverData=%7B"Instance_Name":"'+gettargettances+'"%7D')
						.success(function (data)
						 {
							 //alert(data);
...
if(!$scope.Sourceinstances || !$scope.Sourcedb || !$scope.Targetinstances || !$scope.TargetLoad || !$scope.Targetdb || !$scope.selectedarrayvalue ){
   ...
   //	return false;
	...
	url: serviceurl+'/generateBulkXML?serverData=' + encodeURIComponent(jsonString),
	responseType:'json'
	//data: jsonString
	})
	.success(function(response)
	...
	$scope.GetCoulm = function () {
		$scope.$emit('LOAD');
               ...
               // alert("Selected Value: " + getSourceinstances);
				...
				$http.get(serviceurl+'/sendTestDataColumnJSON?serverData=%7B"Database_Name":"'+$scope.Sourcedb+'","Instance_Name":"'+$scope.Sourceinstances+'","Table_Name":"'+getSourcetable+'"%7D')
						.success(function (data)
						 {
							 alert(data);
							 //$scope.lols = true;
	 ...
	 $scope.TargetGetTable = function () {
		 $scope.$emit('LOAD');
               ...
               // alert("Selected Value: " + getSourceinstances);
				...
				$http.get(serviceurl+'/getTables?serverData=%7B"Database_Name":"'+getTargetdb+'","Instance_Name":"'+$scope.Sourceinstances+'"%7D')
						.success(function (data)
						 {
							// alert(data);
...
/*	 $( "#select" ).change(function() {
  ...
  //Bind the sub menus based on main menu//
    ...
    $scope.getMenusById = function ($index) {
        ...
        $http.get(serviceurl+'/getDatabases?serverData=%7B"Instance_Name":"' + $index + '"%7D')
            .success(function (data) {
                debugger;                    
	 ...
	 /*$scope.getMenusById = function (MenuTitle) {
	     debugger;
	     var subMenusData = [];
	     $http.get(serviceurl+'/getDatabases?serverData=%7BInstance_Name":"' + MenuTitle + '"%7D')
             .success(function (data) {
                debugger;
                 subMenusData.push({ 
                     MenuItems: data 
...
//					tempJson.push({SOURCE_FUNCTION:(dropvalue+ '('+'"'+inputValue+'"'+')')});
	...
	url: serviceurl+'/generateTestDataString?serverData=' + encodeURIComponent(jsonString),
	responseType:'json'
	})
	.success(function(response)
	{
...
/////////////////////// Buttons of test data loadfile import existing tab /////////////////////////// 
	...
	url: serviceurl+'/generateTestDataXML?serverData=' + encodeURIComponent(jsonString),
	responseType:'json'
	})
	.success(function(response)
	{
...
////////////// get database values on select option ///////////////////////
	 $scope.NewtargetGetDb = function (instances) {
		 ...
		 //alert(instances);
				...
				//alert(instances);
				$http.get(serviceurl+'/getDatabases?serverData=%7B"Instance_Name":"'+instances+'"%7D')
						.success(function (data)
						 {
							// alert(data);
	 ...
	 /*$scope.NewTargetGetTable = function () {
		 $scope.$emit('LOAD');
               ...
               // alert("Selected Value: " + getSourceinstances);
				...
				$http.get(serviceurl+'/getTables?serverData=%7BDatabase_Name":"'+NewgetTargetdb+'","Instance_Name":"'+$scope.Sourceinstances+'"%7D')
						.success(function (data)
						 {
							// alert(data);
  ...
  $http.get(serviceurl+"/getSOURCES")
    .success(function (data)
	 ...
	 $scope.GetDb = function (instances) {
		...
		//$scope.loading = !$scope.loading;
                var getSourceinstances = $scope.Sourceinstances;
				$http.get(serviceurl+'/getDatabases?serverData=%7B"Instance_Name":"'+getSourceinstances+'"%7D')
						.success(function (data)
						 {
							// alert(data);
							 $scope.dbnames = data;
...
////////////// get coulmns values on select option ///////////////////////
	...
	var jsonString = JSON.stringify(jsonObject);
				...
				$http.get(serviceurl+'/sendTestDataColumnJSON?serverData='+encodeURIComponent(jsonString))
						.success(function (data)
						 {
							 alert(data);
							 $scope.getablecoulmn = data;
...
$scope.encryptLoadfiles = function (){
	...
	var jsonObject = new Object();
	 for (var i = 0; i < $scope.getablecoulmn.length; i++) {
		...
		console.log(jsonString);
		$http({
	url: serviceurl+'/generateFPE?serverData=' + encodeURIComponent(jsonString),
	method: 'POST',
	//dataType: 'json/text',
	headers: {
...
//            };
            ...
            $scope.openSocialMedia = function(){
            	debugger;

            	var placeholderDiv = document.getElementById("vizContainer");
            	var url = "https://public.tableau.com/profile/amala6003#!/vizhome/Kalakee/Dashboard1?publish=yes";
            	var options = {
            	   hideTabs: true,
            	   width: "800px",
            	   height: "700px",
...
app.controller('socialMediaCntrl', function ($scope) {
...
//////////////// RegisterSourcesCtrl ////////////////////////////////////////
app.controller('RegisterSourcesCtrl', function($scope, $compile, $http, ngDialog) {
	  //console.log('inside BICapabilitiesCtrl controller');
 ...
 // mbScrollbar.recalculate($scope);
  ...
  $scope.registerInstances = function(){
   ...
   $http({
	...
	url: serviceurl+'/saveRegisterInsJsonToDB?serverData=' + encodeURIComponent(jsonString),
	responseType:'json'
	})
	.success(function(response)
	{
  ...
  $scope.registerSOR = function (){
   ...
   $http({
	...
	url: serviceurl+'/SOR_Registration?serverData=' + encodeURIComponent(jsonString),
	responseType:'json'
	})
	.success(function(response)
	{
  ...
  $scope.datamoverResetSOR = function(){
	  $scope.sorName = '';
	  $scope.sorDescription = '';
	  $scope.sorOwner = '';
	  $scope.sorActive = '';
	  $scope.sorCode = '';
...
$scope.rigisterfile = function () {
   ...
   $http({
	...
	url: serviceurl+'/registerFile?serverData=' + encodeURIComponent(jsonString),
	responseType:'json'
	})
	.success(function(response)
	{
...
$scope.rigisterFileReset = function(){
	debugger;
	$scope.fileName = "";
	$scope.filePath = "";
	$scope.RegFiletype = "";
...
$scope.registerTable = function (){
   ...
   $http({
	...
	url: serviceurl+'/tableRegistration?serverData=' + encodeURIComponent(jsonString),
	responseType:'json'
	})
	.success(function(response)
	{
...
var resp = response;		
	...
	.error(function(response)
	{
	 ...
	 $scope.resetRegisterTables = function(){
		  $scope.Instancefortable = "";
		 $scope.tableName = "";
		 $scope.DBname = "";
	 }
...
var ownercnt = [];
///////////// DashboardCtrl /////////////////////////////////////////
app.controller('DashboardCtrl', function($scope, $http, $compile, ngDialog, $interval, $timeout, filterFilter) {
    $scope.$emit('LOAD');
    debugger;
$http({
	method: 'GET',
	...
	url: serviceurl+'/getRunStat?serverData=%7B"JobName":"","Owner":"","JobFreq":"","JobStatus":"","Startdate":"","Enddate":""%7D',
	responseType:'json'
	})
    .success(function (data)
	 {		 
...
$scope.searchSubmit = function (){
	...
	url: serviceurl+'/getRunStat?serverData='+encodeURIComponent(jsonString),
	responseType:'json'
	//data: jsonString
	})
    .success(function (data)
